...
export default function Metrics() {
  ...
  const metricsList = metrics ? [
    { label: 'CPU Utilization', value: metrics.cpu_utilization, limit: '75% Threshold', icon: Cpu, color: 'text-indigo-400', bg: 'bg-indigo-600/10 border-indigo-500/20' },
    { label: 'Memory Usage', value: metrics.memory_usage, limit: '52.5% Used', icon: HardDrive, color: 'text-emerald-400', bg: 'bg-emerald-600/10 border-emerald-500/20' },
    { label: 'Network In/Out', value: `${metrics.network_in} / ${metrics.network_out}`, limit: 'Normal Load', icon: Wifi, color: 'text-sky-400', bg: 'bg-sky-600/10 border-sky-500/20' },
    { label: 'Cluster Health Score', value: metrics.health_score, limit: 'Optimal', icon: Activity, color: 'text-amber-400', bg: 'bg-amber-600/10 border-amber-500/20' },
  ] : [];
